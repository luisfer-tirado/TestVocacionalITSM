class index { // Creación de la clase
  ...
  conectar(l) {
    ...
    session.answers(this.show(), 1000);
  }
      ...
      if (pl.type.is_substitution(answer)) {
        ...
        function mostrarResultados(puntuaciones) {
          ...
          let r1 = new resultado(
              "img/IA.png", //Cargar la imagen de la carrera
              "Ingenieria Ambiental:\nEl porcentaje que aplica a esta carrera es del: " +
                puntuaciones[0] + "/100%" + //Asignar el porcentaje
                "\nPara más información sobre la carrera pulse ",
              "https://misantla.tecnm.mx/ing_amb.html" //Hipervínculo de la página de la carrera
            ),
            // Creación del elemento Ing. Bioquímica
            r2 = new resultado(
              "img/IBQ.png", //Cargar la imagen de la carrera
              "Ingenieria Bioquímica:\nEl porcentaje que aplica a esta carrera es del: " +
                puntuaciones[1] + "/100%" + //Asignar el porcentaje
                "\nPara más información sobre la carrera pulse ",
              "https://misantla.tecnm.mx/ing_ibq.html" //Hipervínculo de la página de la carrera
            ),
            // Creación del elemento Ing. Civil
            r3 = new resultado(
              "img/IC.png", //Cargar la imagen de la carrera
              "Ingenieria Civil:\nEl porcentaje que aplica a esta carrera es del: " +
                puntuaciones[2] + "/100%" + //Asignar el porcentaje
                "\nPara más información sobre la carrera pulse ",
              "https://misantla.tecnm.mx/ing_civ.html" //Hipervínculo de la página de la carrera
            ),
            // Creación del elemento Ing. Electromecánica
            r4 = new resultado(
              "img/IE.png", //Cargar la imagen de la carrera
              "Ingenieria Electromecánica:\nEl porcentaje que aplica a esta carrera es del: " +
                puntuaciones[3] + "/100%" + //Asignar el porcentaje
                "\nPara más información sobre la carrera pulse ",
              "https://misantla.tecnm.mx/ing_iem.html" //Hipervínculo de la página de la carrera
            ),
            // Creación del elemento Ing. en Gestión Empresarial
            r5 = new resultado(
              "img/IGE.png", //Cargar la imagen de la carrera
              "Ingenieria en Gestión Empresarial:\nEl porcentaje que aplica a esta carrera es del: " +
                puntuaciones[4] + "/100%" + //Asignar el porcentaje
                "\nPara más información sobre la carrera pulse ",
              "https://misantla.tecnm.mx/ing_ige.html" //Hipervínculo de la página de la carrera
            ),
            // Creación del elemento Ing. Industrial
            r6 = new resultado(
              "img/II.png", //Cargar la imagen de la carrera
              "Ingenieria Industrial:\nEl porcentaje que aplica a esta carrera es del: " +
                puntuaciones[5] + "/100%" + //Asignar el porcentaje
                "\nPara más información sobre la carrera pulse ",
              "https://misantla.tecnm.mx/ing_ind.html" //Hipervínculo de la página de la carrera
            ),
            // Creación del elemento Ing. Petrolera
            r7 = new resultado(
              "img/IP.png", //Cargar la imagen de la carrera
              "Ingenieria Petrolera:\nEl porcentaje que aplica a esta carrera es del: " +
                puntuaciones[6] + "/100%" + //Asignar el porcentaje
                "\nPara más información sobre la carrera pulse ",
              "https://misantla.tecnm.mx/ing_pet.html" //Hipervínculo de la página de la carrera
            ),
            // Creación del elemento Ing. en Sistemas Computacionales
            r8 = new resultado(
              "img/ISC.png", //Cargar la imagen de la carrera
              "Ingenieria en Sistemas Computacionales:\nEl porcentaje que aplica a esta carrera es del: " +
                puntuaciones[7] + "/100%" + //Asignar el porcentaje
                "\nPara más información sobre la carrera pulse ",
              "https://misantla.tecnm.mx/ing_isc.html" //Hipervínculo de la página de la carrera
            ),
            // Creación del elemento Ing. en Tecnologías de la Información y Comunicaciones
            r9 = new resultado(
              "img/ITICS.png", //Cargar la imagen de la carrera
              "Ingenieria en Tecnologías de la Información y Comunicaciones:\nEl porcentaje que aplica a esta carrera es del: " +
                puntuaciones[8] + "/100%" + //Asignar el porcentaje
                "\nPara más información sobre la carrera pulse ",
              "https://misantla.tecnm.mx/ing_tics.html" //Hipervínculo de la página de la carrera
            ),
